...
SPACE_TXT = '/home/ltausani/Documents/GitHub/ZXDREAM/experiment/SnS_gradient_based/run/low_spaces.txt'

# --PARAMETERS--
TASK = ['invariance'] #['adversarial', 'invariance']
NAME                = f'SnS_GD_Inv_mexp_130425_prova'
...
def get_bmm_args():
    ...
    args = [
        ...
        Task2Sign[task], Task2NatStat[task])
        for rs in RND_SEED
    ...
    nat_thresh      = '"' + "#".join([str(nt)    for _,  _, _,   _,     nt in args]) + '"'
    
    return rand_seeds, rec_score_ly, ref_p, signatures, nat_thresh
    

#NOTE : forse redundant wrt the previous one
...
if __name__ == '__main__':
    ...
    print('Multiple run: ')
    print('[1] multirun SNS Gradient-based')
    print('[2] multirun SNS Gradient-based restricted space')
    ...
    match choice:
        ...
        case 1:
            ...
            rand_seeds, rec_score_ly, ref_p, signatures, nat_thresh = get_bmm_args()
        ...
        case 2:
            ...
            rand_seeds, rec_score_ly, ref_p, signatures, nat_thresh = get_SnS_restricted_space_args_spaceZIPrs()
